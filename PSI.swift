//
//  PSI.swift					 // Passenger Service Information 
...
class PSI: Segment
{
	var otherServiceInformationOsi_9838: C000
	var ssrDetails_C030: [C030]
...
init(otherServiceInformationOsi_9838: C000,
	ssrDetails_C030: [C030] = [],
	pricingticketingInformation_C664: C664,
	...
	self.otherServiceInformationOsi_9838 = otherServiceInformationOsi_9838
	self.ssrDetails_C030 = ssrDetails_C030
...
func description () -> String {
	...
	var descText = "PSI+"
		descEDISeg(&descText, items: otherServiceInformationOsi_9838)
		descEDISeg(&descText, items: ssrDetails_C030)
